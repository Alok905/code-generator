package com.alok.projects.lovable_clone.llm.tools;
...
public class CodeGenerationTools {
    ...
    private final Long projectId;  /// because if the tool contains projectId as argument, then LLM might make a tool call if user misuse this.
